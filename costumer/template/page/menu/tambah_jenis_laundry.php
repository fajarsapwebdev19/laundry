<div class="batas">
    <div class="card">
        ...
        <div class="card-body">
            <button type="button" data-target="#tambah_jenlau" data-toggle="modal" class="btn btn-success mb-4">
                <em class="fas fa-plus"></em> Tambah
            </button>

            <?php require 'btn/jenlau.php'; ?>
            ...
            <table class="table table-responsive-lg datatable">
                ...
                <tbody>
                    <?php
                        $no = 1;
                        $get_data_jenlau = mysqli_query($koneksi, "SELECT * FROM jenis_loundry");
                        while($data = mysqli_fetch_object($get_data_jenlau))
                        {
                            ?>
                                <tr>
                                    ...
                                    <td><?= $data->jenis; ?></td>
                                    <td class="text-center"><?= "Rp. ".number_format($data->harga_perkilo, 0,',','.');?></td>
