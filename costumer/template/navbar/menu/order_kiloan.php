            ...
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu">
                        <a class="dropdown-item active" href="?page=order_kiloan"><em class="fas fa-balance-scale"></em> Loundry Kiloan</a>
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu">
                        ...
                        <a class="dropdown-item" href="?page=pay_satuan"><em class="far fa-credit-card"></em> Loundry Satuan</a>
                    </div>
                </li>
                <li class="nav-item">
